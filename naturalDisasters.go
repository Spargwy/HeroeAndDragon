...
func naturalDisasters(dragon Dragon, hero Hero) (int, int) {
	...
	if chance <= 5 {
		fmt.Print("Похолодание сказалось на драконе...\n")
		...
		fmt.Print("Дракон назвал рыцаря живодером, из-за чего тот окончательно пригорюнился. Дракон этот шанс, конечно не упустил\n")
